...
LPCWSTR g_szAppName = L"Adventure2";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance,
   ...
   // Register class and create window
   {
      ...
      wcex.lpszClassName = L"Adventure2WindowClass";
      ...
      HWND hwnd = CreateWindowExW(0,
                                  ...
                                  hInstance,
                                  nullptr);
      // TODO: Change to CreateWindowExW(WS_EX_TOPMOST, L"Adventure2WindowClass", g_szAppName, WS_POPUP,
