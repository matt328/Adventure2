...
bool ImGui_ImplWin32_Init(void* hwnd) {
   ...
   // Keyboard mapping. Dear ImGui will use those indices to peek into the io.KeysDown[] array that we will update
...
static void ImGui_ImplWin32_UpdateMousePos() {
   ...
   // Obtain focused and hovered window. We forward mouse input when focused or when hovered (and no other window is
   // capturing)
...
IMGUI_IMPL_API LRESULT ImGui_ImplWin32_WndProcHandler(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
   ...
   switch (msg) {
      ...
      case WM_SYSKEYUP: {
         ...
         if (wParam < 256) io.KeysDown[wParam] = down;
